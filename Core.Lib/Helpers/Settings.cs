...
namespace Core.Lib.Helpers
{
    public class Settings : ObservableObject
    {
       ...
       DependencyService.Get<ISettingsStorage>();
        ...
        {
            get => GetValue<string>(); set => SetValue(ref
webAPilUrl, value);
        }
        void SetValue<T>(ref T field, T newValue = default, [CallerMemberName] string
propertyName = null)
        {
